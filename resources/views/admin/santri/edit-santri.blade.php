    ...
    <form action="{{ route('admin.santri.update', $santri->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="no_hp_walisantri" value="{{ old('no_hp_walisantri', $santri->no_hp_walisantri) }}" class="w-full border rounded px-3 py-2 @error('no_hp_walisantri') border-red-500 @enderror">
